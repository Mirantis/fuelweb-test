...
class Test_Deployment_Additional(BaseTestCase):
    @classmethod
    def setUpClass(cls):
        super(Test_Deployment_Additional, cls).setUpClass()
    ...
    def test_deploy_no_ha_delete_add_node_and_redeploy(self):
        PoteenLogger.add_test_case(
            "Environment: Delete one node from environment after successful "
            "deployment. Add new nodes and deploy.")
